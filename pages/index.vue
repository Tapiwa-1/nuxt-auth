        ...
        <div
            ...
            <div class="">
                <div class="sm:fixed sm:top-0 sm:right-0 p-6 text-right z-10">
                    <div v-if="!$profileStore.id" class="">
                        <NuxtLink to="/auth/login"
                            class="font-semibold text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500 mr-2">
                            Login</NuxtLink>
                        <NuxtLink to="/auth/register" href=""
                            class="font-semibold text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">
                            Register</NuxtLink>
                    </div>
                    <div class="" v-else>
                        <NuxtLink to="/dashboard" href=""
                            class="font-semibold text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">
                            Dashboard</NuxtLink>
                    </div>
                </div>
